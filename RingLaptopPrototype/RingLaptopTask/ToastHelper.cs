...
namespace Tasks
{
    public static class ToastHelper
    {
        ...
        internal static ToastNotification PopToast(string title, string content, string tag, string group)
        {
            string xml = $@"<toast activationType='background'>
                                            <visual>
                                                <binding template='ToastGeneric'>
                                                </binding>
                                            </visual>
                                            <audio src='ms-appx:///Assets/TILE_113_Find.mp3' loop='true'/>
                                        </toast>";

            // ms-appx:///Assets/TILE_113_Find.mp3
